...
class ChatPageOneScreen extends StatelessWidget {
  @override
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: Padding(
                    ...
                    child: Row(children: [
                      AppbarCircleimage2(
                          imagePath: ImageConstant.imgProfileimage49x50),
                      Padding(
                          padding: getPadding(left: 13, bottom: 2),
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                AppbarSubtitle1(text: "Alex Dsouza"),
                                Padding(
                                    padding: getPadding(top: 1, right: 36),
                                    child: Row(children: [
                                      Container(
                                          height: getSize(10),
                                          width: getSize(10),
