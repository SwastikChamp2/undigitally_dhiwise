...
class SaniaProfilePageScreen extends StatelessWidget {
                    ...
                    children: [
                      Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                CustomImageView(
                                    imagePath: ImageConstant.imgProfileimage6,
                                ...
                                Padding(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          GestureDetector(
                                              onTap: () {
                                                onTapTxtSaniapatel(context);
                                              },
                                              child: Padding(
                                                  padding: getPadding(left: 1),
                                                  child: Text("Sania Patel",
                                                      overflow:
                      ...
                      Padding(
                          padding: getPadding(left: 15, top: 13, right: 31),
                          child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Padding(
                                    padding: getPadding(top: 10, bottom: 11),
                                    child: Text("free_bird24",
                          ...
                          child: Column(
                              ...
                              children: [
                                Container(
                                    ...
                                    margin: getMargin(right: 17, bottom: 20),
                                    child: Text(
                      ...
                      Padding(
                          ...
                          child: Text("Interests",
                              ...
                              style: AppStyle.txtRobotoRomanRegular16)),
                      Padding(
                          padding: getPadding(left: 10, top: 19, right: 63),
                          child: Row(children: [
                            Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 10, top: 1, bottom: 1),
                                child: Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                      CustomImageView(
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            ...
                            Padding(
                                ...
                                child: Text("Anand Nagar ,Thane,Mumbai",
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle
  ...
  onTapTxtSaniapatel(BuildContext context) {
  ...
  onTapPexelsdaliladal4(BuildContext context) {
