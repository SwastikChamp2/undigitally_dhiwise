...
class MahekProfilePageScreen extends StatelessWidget {
                    ...
                    children: [
                      Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                CustomImageView(
                                    imagePath: ImageConstant.imgProfileimage7,
                                ...
                                Padding(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          GestureDetector(
                                              onTap: () {
                                                onTapTxtMehaksingh(context);
                                              },
                                              child: Padding(
                                                  padding: getPadding(left: 1),
                                                  child: Text("Mehak Singh",
                                                      overflow:
                      ...
                      Padding(
                          padding: getPadding(left: 17, top: 13, right: 31),
                          child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                            ...
                            Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      CustomImageView(
                                          svgPath:
                                              ImageConstant.imgMusicBlack900,
                                          height: getSize(32),
                                          width: getSize(32)),
                                      Padding(
                                          padding: getPadding(top: 8),
  ...
  onTapTxtMehaksingh(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.signupPageScreen);
  }

  onTapProfile2(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.signupPageScreen);
  }

  onTapPexelsdaliladal5(BuildContext context) {
