...
class ChatPageFourScreen extends StatelessWidget {
  @override
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: Padding(
                    ...
                    child: Row(children: [
                      AppbarCircleimage2(
                          imagePath: ImageConstant.imgProfileimage5),
                      Container(
                          height: getVerticalSize(44.03),
                          width: getHorizontalSize(111.880005),
                          margin: getMargin(left: 13, top: 2, bottom: 2),
                          child: Stack(
                ...
                actions: [
                  AppbarImage(
                      ...
                      margin:
                          getMargin(left: 25, top: 27, right: 32, bottom: 4)),
                  AppbarImage(
                      height: getSize(25),
                      width: getSize(25),
